...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: None. All output matched expected results after implementation fix.
    ...
    // Defect(s) Found: None. George was added midway correctly and results match expectations.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: None. Zero-turns correctly treated as infinite and queue logic verified.
    ...
    // Defect(s) Found: None. Negative-turns correctly treated as infinite and rotation proceeds as expected.
    ...
    // Defect(s) Found: None. Exception correctly thrown and message verified.
